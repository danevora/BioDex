...
import { Camera, BookOpen, Trophy } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Photograph animals, identify them with AI, and build your personal
            collection of discoveries. Your own Pokédex for the real world.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm border">
              ...
              <h3 className="text-lg font-semibold mb-2">Your BioDex</h3>
              <p className="text-gray-600">
                Every animal you photograph gets added to your personal BioDex. Watch your collection grow one discovery at a time.
              </p>
            </div>
